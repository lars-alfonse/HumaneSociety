...
namespace HumaneSociety
{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AnimalShotJunction")]
	...
	public partial class Breed : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Species> _Species1;
    ...
    partial void OnpatternChanged();
		...
		public Breed()
		{
			...
			this._Species1 = default(EntityRef<Species>);
			OnCreated();
		}
		...
		public System.Nullable<int> species
		{
			...
			set
			{
				...
				{
					if (this._Species1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		public Species Species1
		{
			get
			{
				return this._Species1.Entity;
			}
			set
			{
				Species previousValue = this._Species1.Entity;
				if (((previousValue != value) 
							|| (this._Species1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Species1.Entity = null;
						previousValue.Breeds.Remove(this);
					}
					this._Species1.Entity = value;
					if ((value != null))
					{
					...
					{
						this._species = default(Nullable<int>);
					}
					this.SendPropertyChanged("Species1");
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DietPlan")]
    ...
    partial void OnspeciesChanged();
		...
		{
			this.SendPropertyChanging();
			entity.Species1 = this;
		}
		
		private void detach_Breeds(Breed entity)
		{
			this.SendPropertyChanging();
			entity.Species1 = null;
		}
	}
	...
	public partial class UserAddress : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _usState;
		
		private EntitySet<Client> _Clients;
		
		private EntityRef<USState> _USState1;
    ...
    partial void OnusStateChanging(System.Nullable<int> value);
    partial void OnusStateChanged();
		...
		public UserAddress()
		{
			...
			this._USState1 = default(EntityRef<USState>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_usState", DbType="Int")]
		public System.Nullable<int> usState
		{
			get
			{
			...
			set
			{
				...
				{
					if (this._USState1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="USState_UserAddress", Storage="_USState1", ThisKey="usState", OtherKey="ID", IsForeignKey=true)]
		public USState USState1
		{
			get
			{
			...
			set
			{
				USState previousValue = this._USState1.Entity;
				if (((previousValue != value) 
							|| (this._USState1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._usState = value.ID;
					}
					else
					{
						this._usState = default(Nullable<int>);
					}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.USState")]
    ...
    partial void OnabbrevChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="USState_UserAddress", Storage="_UserAddresses", ThisKey="ID", OtherKey="usState")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ClientAnimalJunction")]
